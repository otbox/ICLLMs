...
def get_driver():
    ...
    # Caminho específico do seu sistema
    options.binary_location = "/usr/bin/chromium"

    # Inicializa o driver com a versão travada para evitar SessionNotCreatedException
...
NOME_ARQUIVO_JSON = "extracoes/americanas/dinoussauros/3v0c/estrutura_ui.json"
PASTA_SCREENS = "extracoes/americanas/dinossauros/3v0c/screenshots_ui"
...
def scrape_ui_structure(url):
    ...
    try:
        ...
        time.sleep(TIME_TO_START) # GoldenLayout demora para montar o DOM
